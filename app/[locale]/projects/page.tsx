...
const projectsZh = [
  {
    ...
    title: '太陽能板回收系統',
    description: '橫跨 15+ repositories 的 edge-to-cloud 工業整合架構，把 IPC 主程式、PLC 通訊（OPC UA）、SCADA 監控、YOLO 物件辨識與雲端 API 串成從現場設備到雲端業務的完整資料閉環。以 config-driven 設計讓單一主程式因應設備 1.0 到 2.x，省去為每個版本維護一套程式碼的重複開發；再把設備 log 分級上拋雲端、於 SCADA 即時監測與篩選，讓工程師除錯定位的速度約快上 3 倍。',
